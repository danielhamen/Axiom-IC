...
constexpr auto kOperationTable = std::to_array<OperationDefinition>({
    ...
    {OperationKind::SELF, "SELF", 1, "function"},
    {OperationKind::PARAM, "PARAM", 2, "function"},
    {OperationKind::PARAM_DEFAULT, "PARAM_DEFAULT", 3, "function"},
    ...
    {OperationKind::ARG_GET_DEFAULT, "ARG_GET_DEFAULT", 3, "function"},
    {OperationKind::KWARG_GET_DEFAULT, "KWARG_GET_DEFAULT", 3, "function"},
    ...
    // NAMESPACES
    {OperationKind::NAMESPACE_NEW, "NAMESPACE_NEW", 2, "namespace"},
    {OperationKind::NAMESPACE_ADD, "NAMESPACE_ADD", 3, "namespace"},
    {OperationKind::NAMESPACE_GET, "NAMESPACE_GET", 3, "namespace"},
    {OperationKind::NAMESPACE_HAS, "NAMESPACE_HAS", 3, "namespace"},
    {OperationKind::NAMESPACE_DELETE, "NAMESPACE_DELETE", 2, "namespace"},
    {OperationKind::NAMESPACE_KEYS, "NAMESPACE_KEYS", 2, "namespace"},
    {OperationKind::NAMESPACE_BIND_FN, "NAMESPACE_BIND_FN", 3, "namespace"},
    {OperationKind::NAMESPACE_CALL, "NAMESPACE_CALL", 3, "namespace"},
    ...
    {OperationKind::STRUCT_DEF_STATIC_METHOD, "STRUCT_DEF_STATIC_METHOD", 3, "struct"},
    ...
    {OperationKind::STRUCT_STATIC_CALL, "STRUCT_STATIC_CALL", 3, "struct"},
    ...
    {OperationKind::IMM, "IMM", 1, "memory"},
